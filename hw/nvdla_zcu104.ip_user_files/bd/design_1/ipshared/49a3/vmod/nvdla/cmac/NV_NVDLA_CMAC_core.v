...
,.fi_mux_fdata_in (fi_mux_fdata_in) //|< i
,.fi_mux_fsel_in (fi_mux_fsel_in) //|< i
,.fi_mux_sel (fi_mux_sel[8-1:0]) //|< i
);
...
,.fi_mux_fdata_in (fi_mux_fdata_in) //|< i
,.fi_mux_fsel_in (fi_mux_fsel_in) //|< i
,.fi_mux_sel (fi_mux_sel[16-1:8]) //|< i
);
...
,.fi_mux_fdata_in (fi_mux_fdata_in) //|< i
,.fi_mux_fsel_in (fi_mux_fsel_in) //|< i
,.fi_mux_sel (fi_mux_sel[24-1:16]) //|< i
);
...
,.fi_mux_fdata_in (fi_mux_fdata_in) //|< i
,.fi_mux_fsel_in (fi_mux_fsel_in) //|< i
,.fi_mux_sel (fi_mux_sel[32-1:24]) //|< i
);
